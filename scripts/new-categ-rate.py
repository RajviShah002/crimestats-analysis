# This script simply uses the 2017 population list to populate the rate column for the newly added category 'Sexual harassment and molestation of women'

import csv
from os.path import join, basename

DATADIR = '../static/data'
pop_file = join(DATADIR,'female-2017.csv')
